...
export default class ExportToPdf extends React.Component<IExportToPdfProps, IExportToPdfState> {
  ...
  private getViewFields() {
    return [
      ...
      { displayName: "Prozessverantwortliche", name: "DispName", sorting: true, minWidth: 100, maxWidth: 250 },
      { displayName: "Turnus", name: "DispName0", sorting: true, minWidth: 100, maxWidth: 250 },
